...
class Archives extends CI_Model 
{
	...
	public function restoreStudent($id)
	{
		...
		$data = array(
				...
				'contract_id'		=> $student[0]['contract_id'],
				...
				'supply'			=> $student[0]['supply'],
				'add_by'			=> $student[0]['add_by'],
				'study_session'		=> $student[0]['study_session'],
				'status'			=> 1
				);
		...
		//$this->student->updateDeleteStudent($data, $id);
	}
