...
class CollegeApi extends CI_Controller {
    ...
    public function StudentLogin(){
        ...
        INNER JOIN campuses ON campuses.campus_id = classes.campus_id WHERE roll_no = '".$roll_no."' AND password = '".$password."'";
...
// 		$this->db->where(array('campus_id'=>$campus_id));
    ...
    public function GetChats(){
        ...
        $qry = "SELECT chats.*, issue_types.name as issue, questions.question FROM `chats` LEFT JOIN issue_types ON issue_types.id = chats.category LEFT JOIN questions ON questions.question_id = chats.question_id WHERE student_id = $student_id ORDER BY chats.chat_id DESC";
    ...
    public function GetCourseSubjects(){
        ...
        $subject_year_semester = $this->input->post('year_semester');
