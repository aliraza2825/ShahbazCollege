				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i> Add (<?php echo $campuses[0]['campus_name'];?>) Documents
							</div>
						</div>
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/campuses/upload/<?php echo $this->uri->segment(3)?>" enctype="multipart/form-data">
								<div class="form-body">
                                    <div class="row">
                                    	<div class="col-md-12">
                                        	<hr />
            ...
            <div class="row">
            	<div class="col-md-12" style="border:1px solid #CCC; padding:20px;">
                    ...
                    <div class="col-md-3" style="overflow:hidden; max-height:300px; position:relative">
                    	<a href="<?php echo site_url();?>/campuses/delete_documents/<?php echo $this->uri->segment(3).'/'.$document['campus_document_id'];?>">
                    	...
                    	<a href="<?php echo base_url().'uploads/'.$document['document'];?>" target="_blank">
                        	<img src="<?php echo base_url().'uploads/'.$document['document'];?>" alt="" width="100%" />
                        </a>
                    </div>
                    <?php
                    	endforeach;
