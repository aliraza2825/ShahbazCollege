            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-cascade">
                    ...
                    <div class="portlet-body form">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/expenses/all_expenses_subhead_report">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select name="campus_ids[]" id="select2_sample1" class="form-control input-inline input-large select2">
									...
									<div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <select name="categories" class="form-control input-inline input-large">
                    ...
                    if(@count(@$campuses)>0 ):
                        ...
                        <div class="portlet-body">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_2">
                                ...
                                $i = 0;
                                $total=0;
                                foreach($selected_campuses as $expense):
                                    ?>
                                    <tr class="odd gradeX">
                                        <td >
                                            <?php echo $i;?>
                                        ...
                                        <td>
                                            <?php $exp = $this->db->get_where('expense_category', array('expense_category_id'=>$this->input->post('categories')))->row();
                                            echo $exp->name.'<br />';?>
                                        </td>
                                        ...
                                        <td>
                                            <?php
                                                ...
                                                $amount = get_inner_expenses($this->input->post('categories'),"",$from_date,$to_date,$expense['campus_id'],0);
                                            ?>
                                        </td>
                                        <td>
<?php echo $amount ?>
