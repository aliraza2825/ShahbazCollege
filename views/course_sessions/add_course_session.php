	...
	<div class="page-content-wrapper">
		<div class="page-content">
				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-plus"></i> Add Course Session
							</div>
						</div>
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/course_sessions/insert_course_session">
								<div class="form-body">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control input-inline input-large" name="session_name" placeholder="2022-2024" value="" required>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<div class="input-group input-large date date-picker" data-date="<?php echo date('Y-m-d')?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
												<input type="text" name="dead_line_add_edit_student" class="form-control" value="<?php echo date('Y-m-d');?>" readonly>
									...
									<div class="form-group">
										<label class="control-label col-md-3">Last Date of Payment plan <span class="required">*</span></label>
										<div class="col-md-3">
											<div class="input-group input-large date date-picker" data-date="<?php echo date('Y-m-d')?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
												<input type="text" name="last_date_auto_fee_installment" class="form-control" value="<?php echo date('Y-m-d');?>" readonly>
												<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control input-inline input-large" name="per_student_fee" placeholder="Enter per student fee" value="" required>
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											<div class="input-group input-large date date-picker" data-date="<?php echo date('Y-m-d')?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
												<input type="text" name="maximum_fee_last_date" class="form-control" value="<?php echo date('Y-m-d');?>" readonly>
												<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control input-inline input-large" name="minimum_installment_fee" placeholder="Enter Minimum Student Installment Fee This Session" value="" required>
											<span class="help-inline"></span>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-9">
											<input type="text" class="form-control input-inline input-large" name="maximum_difference_installments" placeholder="Enter Maximum Difference in days" value="" required>
         ...
         <!--                                   <input type="radio" name="council_board_fee" id="optionsRadios3" class="council_board_fee" value="Yes" checked> Yes </label>-->
         <!--                                   <label class="radio-inline">-->
         <!--                                   <input type="radio" name="council_board_fee" id="optionsRadios4" class="council_board_fee" value="No"> No </label>-->
         <!--                               </div>-->
         <!--                           </div>-->
									<div>
    									<div class="form-group">
    									...
    									<div class="form-group" style="display: none">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" class="form-control input-inline input-large first_time_council_fee" name="first_time_council_fee" placeholder="Enter First Time Council Fee" value="<?php echo @$feerule['first_time_council_fee'] ?>" min="0" required>
                                                <span class="help-inline"></span>
                                            </div>
                                        </div>
    									<div class="form-group" style="display: none">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group input-large date date-picker" data-date="<?php echo date('Y-m-d');?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
                                                    <input type="text" name="last_date_council_fee" class="form-control last_date_council_fee" value="<?php echo date('Y-m-d');?>" readonly>
                                                    <span class="input-group-btn">
                                                    <button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
                                                    </span>
                                                </div>
									...
									<div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" class="form-control input-inline input-large" name="re_admission_fee" placeholder="Re Admission Amount" min="0" value="" required>
                                                <span class="help-inline"></span>
									...
									<div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input type="number" class="form-control input-inline input-large" name="freeze_fee" placeholder="Freeze Amount" min="0" value="" required>
                                                <span class="help-inline"></span>
                                            </div>
                                    </div>
									<div class="form-group">
										...
										<div class="col-md-3">
											<div class="input-group input-large date date-picker" data-date="<?php echo date('Y-m-d')?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
												<input type="text" name="freeze_last_date" class="form-control" value="<?php echo date('Y-m-d');?>" readonly>
												<span class="input-group-btn">
												<button class="btn default" type="button"><i class="fa fa-calendar"></i></button>
												</span>
											</div>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn green">Add Course Session</button>
