    	...
    	<div class="segment">
            ...
            <table>
            	<tbody>
                    ...
                    <tr>
                    	<td>Name : <?php echo $challan['first_name'].' '.$challan['last_name'];?></td>
                        <td>F / N : <?php echo $challan['father_name'];?></td>
                    </tr>
                    <tr>
                    	<td>Roll # : <?php echo $challan['roll_no']?></td>
                        <td>Class : <?php echo $challan['class_name']?></td>
                    </tr>
                    <tr>
                        <td style="width: 37%">Merged Challans </td>
                        <td style="word-wrap:break-word;"><?php echo $challan['merged_challan']?></td>
                    </tr>
                </tbody>
            </table>
            ...
            <table width="100%">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="word-wrap:break-word;">Rs. <?php echo $challan['totamount'];?></td>
                    </tr>
                    <tr>
                    	<td>Previous Dues</td>
                    ...
                    <tr>
                        <td>Discount</td>
                        <td>Rs. <?php echo $disc= (($challan['totamount']/100)*$challan['discount'])?></td>
                    </tr>
                    <tr>
                    	<td><strong>Net Payable Amount</strong></td>
                        <td><strong>Rs. <?php echo $challan['totamount']+$fee_fine+$challan['extra_amount']+$bank_charges-$disc;?></strong></td>
                    </tr>
                </tbody>
            </table>
            <p class="bank" style="text-align:left; margin-top:10px;">Rules &amp; Regulations</p>
            <p class="description">Bank charges will be paid by student.</p>
