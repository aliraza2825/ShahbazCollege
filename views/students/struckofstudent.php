...
?>	
                ...
                <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <div class="portlet box green ">
                            ...
                            <?php
                            if ( @$struckofdata[count($struckofdata)-1]['status'] != 'pending'): ?>
                                <div class="col-md-12" style="margin: 7px">
                                    <row>
                                        <input type="submit" class="btn yellow" name="student_check" value="Add Details" data-toggle="modal" href="#start_process" />
                            <?php
                            endif;
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX <?php echo @$payment_alert;?>">
                                                ...
                                                <td>
                                                    <?php echo $data['action_type'];?>
                                                </td>
                                                <td>
                                                    <?php echo strtoupper($data['status']);?>
                                                </td>
                                                <td>
                                                    <a  class="btn red" target="_blank" href="<?php echo site_url().'/students/struckofstudentviewprocess/'.$studentid.'/'.$data['process_count']?>">
            ...
            <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?php echo site_url();?>/students/addstruckofdetails/<?php echo $studentid?>/<?php echo sizeof($struckofdata)?>">
                <div class="form-body">
                    <div class="form-group">
                        <label class="col-md-4 control-label">Struck of Type <span class="required">*</span></label>
                        <div class="col-md-8 radio-list" required>
                            <label class="radio-inline">
                                <input type="radio" class="delete_type" name="delete_type" id="optionsRadios1" value="0" checked>Process</label>

                            <label class="radio-inline">
                                <input type="radio" class="delete_type" name="delete_type" id="optionsRadios2" value="1">Immediate Action</label>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="start_process" tabindex="-1"   data-width="800" >
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            <h4 class="modal-title">Please enter struck of details <span class="required">*</span></h4>
        </div>
        <div class="modal-body">
            <form class="form-horizontal" enctype="multipart/form-data" role="form" method="post" action="<?php echo site_url();?>/students/start_process/<?php echo $studentid?>">
                <div class="form-body">
                    <div class="form-group">
                        <label class="col-md-4 control-label">Struck of Type <span class="required">*</span></label>
                        <div class="col-md-8 radio-list" required>
                            <label class="radio-inline">
                                <input type="radio" class="delete_type" name="delete_type" id="optionsRadios1" value="process" checked>Process</label>
                            <label class="radio-inline">
                                <input type="radio" class="delete_type" name="delete_type" id="optionsRadios2" value="immediate">Immediate Action</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-4 control-label">Reason in Details</label>
                ...
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <input type="hidden" name="add_by" value="<?php echo $this->session->userdata('name');?>" />
                            <button type="submit" class="btn red">Start Process</button>
                        </div>
                    </div>
                </div>
            </form>
