				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-list"></i> Check Assignments
							</div>
						</div>
						<div class="portlet-body form">
                            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/assignments/all_assignments">
								<div class="form-body">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
                            ...
                            <tr class="odd gradeX">
								...
								<td>
									<?php echo $assignment['start_date'].' / '.$assignment['end_date'];?>
								</td>
                                <td>
								...
								<td>
									<?php
										$topics = explode(',',$assignment['topic_ids']);
								...
								<td>
									MCQs : <?php echo count(explode(',',$assignment['mcqs']));?>
									<br />
									Mcqs Marks : <?php echo $assignment['mcqs_marks'];?>
									<br />
									Short Questions : <?php echo count(explode(',',$assignment['short_questions']));?>
									<br />
									Mcqs Marks : <?php echo $assignment['short_questions_marks'];?>
									<br />
									Practicals : <?php echo count(explode(',',$assignment['practicals']));?>
									<br />
									Practicals Marks : <?php echo $assignment['practical_marks'];?>
								</td>
								<td>
									<?php echo $assignment['total_marks']?>
								</td>
								<td>
									<?php echo $assignment['add_by']?>
								</td>
								<td>
                                    ...
                                    <br /><br />
                                    <a onclick="return confirm('Are you sure you want to delete this Assignment?')" href="<?php echo site_url();?>/assignments/deleteassignment/<?php echo $assignment['assignment_id'];?>" class="btn red" ><i class="fa fa-trash"></i> Delete Assignment</a>
								</td>
							</tr>
                            <?php
								$i++;
