				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-edit"></i> Edit Assign Task
							</div>
						</div>
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/recovery_management/update_comission/<?php echo $this->uri->segment(3);?>">
								<div class="form-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="number" min="0" class="form-control input-inline input-medium" name="min_fine_amount" value="<?php echo $users[0]['min_fine_amount'];?>" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="number" min="0" class="form-control input-inline input-medium" name="fine_amount_percentage" value="<?php echo $users[0]['fine_amount_percentage'];?>" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
									...
									<div class="comission_area">
										<?php
											$rules = $this->db->get_where('recovery_management_rules',array('recovery_management_id'=>$users[0]['recovery_management_id']))->result_array();
