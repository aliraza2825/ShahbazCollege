				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/news_updates/insert" >
								<div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											...
											<button onclick="location.href = '<?php echo site_url()?>/news_updates/all_news'" type="button" class="btn default">Cancel</button>
										</div>
									</div>
								</div>
							</form>
