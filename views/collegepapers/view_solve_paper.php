...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<div class="left paper_detail">
				<p class="text-center" style="font-size:14px;"><strong>Subject : <?php echo $this->db->get_where('course_subjects',array('course_subject_id'=>$paper['subject_id']))->row()->subject_name;?></strong></p>
