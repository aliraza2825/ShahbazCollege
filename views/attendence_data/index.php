				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form">
                            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/attendence_data/insert">
								<div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control select2me" name="teacher_student_id" id="teacher_student_id" required>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-md-9">
											<input type="number" class="form-control input-inline input-medium" name="machine_id" placeholder="Enter machine ID" value="">
											<span class="help-inline"></span>
										</div>
									</div>
								</div>
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn green">Add Record</button>
