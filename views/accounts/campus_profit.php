    ...
    <div class="page-content">
        <div class="row">
            <div class="col-md-12 ">
                ...
                $datediff = (strtotime($now) - strtotime($from_date));

                $datediffer = abs(round($datediff / 86400))-1;
                ?>
                            ...
                            <div class="form-body">
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-3">
                                            <div class="input-group input-medium date date-picker" data-date="<?php echo $till_date;?>" data-date-format="yyyy-mm-dd" data-date-viewmode="years" data-date-start-date="-<?php echo $datediffer;?>d" data-date-end-date="-1d">
            ...
            <div class="row">
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat red">
                            ...
                            <div class="more">
                                ...
                                if ($port_campuses):
                                    foreach (@$port_campuses as $i=>$port_campus):
                                        ...
                                        $this_exp = totalExpense($port_campus, $from_date, $till_date);
                        ...
                        <a class="more" href="<?php echo site_url();?>/accounts/total_expenses/<?php echo $from_date;?>/<?php echo $till_date;?>/<?php echo $this->uri->segment(3);?>">
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat red">
                        ...
                        <div class="details">
                            <div class="number">
                                <?php
                                   $special_expense = specialExpense($this->uri->segment(3), $from_date, $till_date);
                                   echo $special_expense;
                                ?>
                            </div>
                            <div class="desc">
                                Special Expenses
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat green-haze">
                        ...
                        <div class="details">
                            <div class="number">
                                <?php
                                echo $exp+$totalExpense+$special_expense;
                                $totalExpense = $exp+$totalExpense+$special_expense;
                                ?>
                            </div>
                            <div class="desc">
                                Total Expense
                ...
                <div class="col-lg-2 col-md-3 col-sm-6 col-xs-12">
                    <div class="dashboard-stat green-haze">
                        ...
                        <div class="details">
                            <div class="number">
                                <?php
                                // $earn = $this->db->select("*")->get_where('student_shift_details', array('to_class'=>$this->uri->segment(3),'received_status'=>"0"))->result_array();
                                // echo '<pre>';
                                // print_r($earn);
                                // echo '</pre>';
                    ...
                    <div class="dashboard-stat red">
                        ...
                        <div class="details">
                            <div class="number">
                                <?php
                                    if ($port_campuses):
                                        $notApprovedExpenses=0;
                                        foreach (@$port_campuses as $i=>$port_campus):
                                            $notApprovedExpenses+=getNotApprovedExpenses($port_campus, $from_date, $till_date);
                                        endforeach;
                                    endif;
                                    echo 'Rs '.$notApprovedExpenses;
                                ?>
                            </div>
                            <div class="desc">
...
<!--                                            <input type="radio" name="section" id="optionsRadios5" value="cash"> Cash </label>-->
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn green" <?php if(getNotApprovedExpenses($campus['campus_id'], $from_date, $till_date)>0){echo 'disabled';}?>>Submit</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            foreach($profits as $profit):
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <?php echo $profit['total_recovery'];?>
