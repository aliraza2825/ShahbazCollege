...
<!--                                --><?php //endif; ?>
                                ...
                                <td>
                                    <button type="button" onclick="deleteItem(<?php echo $closing_rule['trans_id']?>,<?php echo $i?>)" id="delete-<?php echo $i?>" class="btn green">Delete</button>
                                    <button id="loading_button-<?php echo $i?>" style="display: none" class="button-tag" type="button">
                                        <i class="fata fa fa-spinner fa-spin"></i>Deleting
                                    </button>
                                </td>
                            </tr>
                            <?php
