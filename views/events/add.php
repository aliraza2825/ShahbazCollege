				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/events/insert">
								<div class="form-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-6">
                                        	<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" class="form-control input-inline input-medium" name="name" placeholder="Enter image title" value="" required>
                                                    <span class="help-inline"></span>
                                                </div>
                                            </div>
                                        </div>
