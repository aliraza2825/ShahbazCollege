                                        	...
                                        	<div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="staff_shift_id" class="form-control input-inline input-large" required>
                                                        ...
                                                        <option value="<?php echo $staff_shift['staff_shift_id'];?>" <?php if($staff_shift['staff_shift_id']==$teacher['staff_shift_id']){echo 'selected';}?>><?php echo $staff_shift['shift_name'];?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                            </div>
