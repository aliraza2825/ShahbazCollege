				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form">
                            <form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/papers/insert" enctype="multipart/form-data">
								<div class="form-body">
									<div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="subject_id" class="form-control input-inline input-medium">
												...
												?>
                                                <option value="<?php echo $subject['subject_id']?>"><?php echo $subject['name']?> (<?php echo $this->db->get_where('classes', array('class_id'=>$subject['class_id']))->row()->name;?>)</option>
                                                <?php
                                                	endforeach;
												?>
                                            </select>
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
                                            ...
                                            <button type="submit" class="btn green">Add Paper</button>
