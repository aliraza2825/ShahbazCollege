				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-user"></i> Online Applications for Admission (Approved by person)
							</div>
						</div>
                        <div class="portlet-body">
                            ...
                            <tr class="odd gradeX <?php if(count($cnic_check)>0){echo 'alert-success';}?>">
                                ...
                                <td>
                                	<form action="<?php echo site_url();?>/online_application/checked_applications" method="post">
