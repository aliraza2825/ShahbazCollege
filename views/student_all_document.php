...
<div class="container">
    ...
    <div class="picture" style="margin-bottom: 10px;float: left;width: 100%;">
        ...
        <div class="left photo-container" style="width: 25%;">
            <div class="right photo" style="background-image:url('<?php if(@$photo[0]['online_image'] == ''){ echo base_url();?>uploads/<?php echo @$photo[0]['image']; } else echo @$photo[0]['online_image'];?>'); background-size:100% 100%;">
    ...
    <div class="id_card" style="margin-top: 10px;float: left;width: 100%;">
        ...
        foreach($id_card as $list):
            ...
            <div class="left photo-container" >
                <div class="right photo" style="width: 93%;height: 200px;background-image:url('<?php if(@$list['online_image'] == ''){ echo base_url();?>uploads/<?php echo @$list['image']; } else echo @$list['online_image'];?>'); background-size:100% 100%;">
...
<br>
        ...
        <div class="content" style="position:relative;">
            ...
            <div class="roll_no_slip" style="position:relative;">
                ...
                <div class="left bottom-photo-container" style="margin-top:10px;">
                    ...
                    <div class="left photo" style="background-image:url('<?php if(@$photo[0]['online_image'] == ''){ echo base_url();?>uploads/<?php echo @$photo[0]['image']; } else echo @$photo[0]['online_image'];?>'); background-size:100% 100%;">
    ...
    <div class="result_card">
        <img src="<?php if(@$result_card[0]['online_image'] == ''){ echo base_url();?>uploads/<?php echo @$result_card[0]['image']; } else echo @$result_card[0]['online_image'];?>');" style="width:110%;height: 1220px;margin-top: 25px;margin-left: -40px">
