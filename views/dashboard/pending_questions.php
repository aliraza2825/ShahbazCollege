					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td>
                                    <?php echo $question['subject_name']?>
                                </td>
                                <td>
								...
								<td>
                                    <a target="_blank" class="btn purple" href="<?php echo site_url();?>/test_engine/edit_question/<?php echo $question['question_id']?>/<?php echo $question['topic_id']?>"><i class="fa fa-edit"></i> Edit</a>

                                    <a class="btn green" href="<?php echo site_url();?>/dashboard/approve_question/<?php echo $question['question_id']?>"><i class="fa fa-check"></i> Approve</a>
									
                                    <a class="btn red" onclick="return confirm('Are you sure you want to reject this Question?')" href="<?php echo site_url();?>/dashboard/delete_question/<?php echo $question['question_id']?>"><i class="fa fa-trash"></i> Reject</a>
								</td>
							</tr>
                            <?php
								$i++;
