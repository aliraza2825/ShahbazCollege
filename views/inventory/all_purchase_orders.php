				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/inventory/all_purchase_orders">
								<div class="form-body">
									<div class="row">
										<div class="col-md-6">
					...
					<div class="portlet box grey-cascade">
						...
						<div class="portlet-body">
                            ...
                            <tr class="odd gradeX">
								...
								<td>
									<?php
										$this->db->select('product_names.product_name,product_names.product_name_id,purchase_requests.purchased,purchase_requests.product_quantity');
										...
										foreach($products as $product)
										{
											...
											{
												echo '<i class="fa fa-check"></i> '.$product['product_name'].' ('.$product['product_quantity'].' Pcs)<br />';
											}
											else
											{
												echo '<i class="fa fa-close"></i> '.$product['product_name'].' ('.$product['product_quantity'].' Pcs)<br />';
											}
										}
									?>
								</td>
								...
								<td>
									<?php
										foreach($products as $product)
										{
											if($product['purchased']==1)
											{
												echo '<a href="'.site_url().'/inventory/return_product/'.$purchase_request['purchase_no'].'/'.$product['product_name_id'].'" class="btn red">'.$product['product_name'].'</a>';
											}
											else
											{
												//echo '<i class="fa fa-close"></i> '.$product['product_name'].' ('.$product['product_quantity'].' Pcs)<br />';
