				...
				<div class="col-md-12">
					...
					<div class="portlet box grey-cascade">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-list"></i> GRN Gate Approval
							</div>
						</div>
                            ...
                            <tr class="odd gradeX grn_gate_approval_<?php echo $i;?>">
								...
								<td>
									<div class="table-group-actions">
										<form action="<?php echo site_url();?>/inventory/grn_gate_entry" method="post">
											<select name="gate_approval" class="table-group-action-input form-control input-inline input-small input-sm" required>
												<option value="">Pending</option>
												<option value="1">Received</option>
											</select>
											<input type="hidden" name="purchase_request_id" value="<?php echo $purchase_order['purchase_request_id'];?>" />
											<button type="submit" class="btn btn-sm yellow table-group-action-submit">Submit</button>
										</form>
									</div>
								</td>
							</tr>
