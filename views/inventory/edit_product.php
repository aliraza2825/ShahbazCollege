				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/inventory/update_product/<?php echo $this->uri->segment(3);?>" enctype="multipart/form-data">
								<div class="form-body">
									<div class="row">
                                        <div class="col-md-12">
                                                    ...
                                                    <span class="help-inline">
                                                    	<?php
                                                        	if($products[0]['product_image']!=''):
                                                                if($products[0]['online_product_image']==''):
														?>
                                                        <a href="<?php echo base_url();?>inventory_images/<?php echo $products[0]['product_image'];?>" target="_blank"><img src="<?php echo base_url();?>inventory_images/<?php echo $products[0]['product_image'];?>" width="100" /></a>
                                                        <?php
                                                                else:
                                                        ?>
                                                        <a href="<?php echo str_replace($bucket_address,$cloudfront_address,$products[0]['online_product_image']);?>" target="_blank"><img src="<?php echo str_replace($bucket_address,$cloudfront_address,$products[0]['online_product_image']);?>" width="100" /></a>
                                                        <?php
                                                                endif;
                                                        	endif;
														?>
                                                    ...
                                                    <span class="help-inline">
                                                    	<?php
                                                        	if($products[0]['purchase_slip']!=''):
                                                                if($products[0]['online_purchase_slip']==''):
														?>
                                                        ...
                                                        ?>
                                                        <a href="<?php echo str_replace($bucket_address,$cloudfront_address,$products[0]['online_purchase_slip']);?>" target="_blank"><img src="<?php echo str_replace($bucket_address,$cloudfront_address,$products[0]['online_purchase_slip']);?>" width="100" /></a>
                                                        <?php
                                                                endif;
                                                        	endif;
														?>
