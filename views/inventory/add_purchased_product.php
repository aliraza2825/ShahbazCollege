				...
				<div class="col-md-12 ">
					...
					<div class="portlet box green ">
						...
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/inventory/insert_purchased_product" enctype="multipart/form-data">
								<div class="form-body">
									<div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="campus_id" class="form-control input-inline input-large select2 campus" required>
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $campus['campus_id'];?>" <?php if($campus['campus_id']==$purchase_request[0]['campus_id']){echo 'selected';}?>><?php echo $campus['campus_name'];?></option>
                                                        <?php
                                                            endforeach;
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="room_id" class="form-control input-inline select2 input-large rooms" required>
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $room['room_id'];?>" <?php if($room['room_id']==$purchase_request[0]['room_id']){echo 'selected';}?>><?php echo $room['room_name'];?></option>
                                                        <?php
                                                            endforeach;
                                                        ?>
                                                    </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <select name="subroom_id" class="form-control input-inline input-large select2 subrooms">
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $subroom['subroom_id'];?>" <?php if($subroom['subroom_id']==$purchase_request[0]['subroom_id']){echo 'selected';}?>><?php echo $subroom['subroom_name'];?></option>
                                                        <?php
                                                            endforeach;
                                                        ?>
                                                    </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    ...
                                                    <?php echo $this->db->get_where('product_names',array('product_name_id'=>$purchase_request[0]['product_name_id']))->row()->product_name;?>
                                                    <input type="hidden" name="product_name_id" value="<?php echo $purchase_request[0]['product_name_id'];?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
													<?php
														//GET ALREADY ADDED QR CODE OR GENERATE NEW ONE
														$this->db->limit(1);
														$product = $this->db->get_where('products',array('product_name_id'=>$purchase_request[0]['product_name_id']))->result_array();
														if(count($product)>0)
														{
													...
													?>
                                                    <input type="number" class="form-control input-inline input-large" name="qr_code" placeholder="Enter Product QR Code" value="<?php echo $qr_code;?>" min="1" readonly required>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php echo $product_price = round($purchase_request[0]['purchase_price']/$purchase_request[0]['product_quantity']);?>
                                                    <input type="hidden" name="total_price" value="<?php echo $purchase_request[0]['purchase_price'];?>" />
                                                    <input type="hidden" name="estimated_price" value="<?php echo $product_price;?>" />
                                                    <span class="help-inline">Note: This is the price of 1 Unit.</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Purchase Slip / Guarantee Card</label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php echo $purchase_request[0]['product_quantity'];?>  
                                                    <input type="hidden" name="product_quantity" value="<?php echo $purchase_request[0]['product_quantity'];?>" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
								...
								<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">
                                            <input type="hidden"  name="purchased_by" value="<?php echo $purchase_request[0]['purchased_by']?>" />
                                            <input type="hidden"  name="purchase_request_id" value="<?php echo $purchase_request[0]['purchase_request_id']?>" />
                                            <input type="hidden"  name="purchase_no" value="<?php echo $purchase_request[0]['purchase_no']?>" />
