					...
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption">
								...
								?>
								<i class="fa fa-user"></i> <?php echo $this->session->userdata('first_name').' '.$this->session->userdata('last_name');?>
                                ( Admission Incentive Details)
							</div>
						</div>
						<div class="portlet-body form">
							<form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/admission_management/check_recovery/<?php echo $this->uri->segment(3)?>">
								<div class="form-body">
                                    <div class="row">
