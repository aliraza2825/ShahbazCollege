            ...
            <div class="col-md-12">
                ...
                <div class="portlet box grey-cascade">
                    ...
                    <div class="portlet-body form">
                        <form class="form-horizontal" role="form" method="post" action="<?php echo site_url();?>/expenses/all_expenses_report">
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-6">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_2">
                                ...
                                foreach($expenses as $expense):
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="<?php echo site_url().'/expenses/all_expenses_details/'.$from_date.'/'.$to_date.'/'.$expense['campus_id'].'/'.$expense['expense_category_id'];?>" target="_blank">
